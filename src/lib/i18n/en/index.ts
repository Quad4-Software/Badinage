...
const en = {
  ...
  jidHint: 'Your XMPP address, or an IRC nickname together with the server WebSocket address below.',
  addressOrNick: 'Address or nickname',
  ...
  serverHint: 'Optional for XMPP. For IRC this is the WebSocket endpoint, for example wss://irc.example.org',
  ...
  presenceAsk: 'Wants to see your presence',
  accept: 'Accept',
  deny: 'Deny',
  delivered: 'Delivered',
  read: 'Read',
  ...
  viewProfileOf: 'View profile of {name:string}',
  memberOfRoom: 'Member of {room:string}',
  ...
  invitedBy: 'Invited by {from:string}',
