...
| XEP-0045      | Multi-user chat            | partial  | join/leave, occupants, roles, subject. Invites and config open |
...
| XEP-0384      | OMEMO                      | partial  | 1:1 chat encrypt/decrypt, PEP devices + bundles, BTBV trust UI |
